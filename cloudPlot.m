...
if ( nArgs >= 1 ); X = args{1}(:,1); Y = args{1}(:,2); end
if ( nArgs >= 2 ); bins = args{2}; end

assert ( nArgs <= 2, 'No more than 6 arguments plus name-value pairs allowed' );
assert ( nArgs >= 1, 'At least 1 arguments required' );
